...
public class Utility
{
	...
	public static String readDataFromExcel(int row, int cell) throws EncryptedDocumentException, IOException
	{
		...
		Reporter.log("Reading data from excel row is"+cell,true);
	...
	public static void takeScreenshot(WebDriver driver,String fileName) throws IOException
	{
          ...
          File dest = new File("F:\\ScreenShot\\"+fileName+".png");
	...
	public static String readDataFromPropertyFile(String key) throws IOException
	{
		...
		//2 create object of fileInput Stream
		FileInputStream myFile=new FileInputStream("F:\\Selenium\\property.properties");
